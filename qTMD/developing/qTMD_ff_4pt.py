...
conf_path = "/lus/flare/projects/StructNGB/lattices/64I/Coulomb/ckpoint_lat.Coulomb.%s" % conf
evec_path = "/lus/flare/projects/StructNGB/lattices/64I/%s.evecs/lanczos.output" % conf
lat_tag = "64I"
sm_tag = 'CG'
...
'''             Set up solver            '''
''' ------------------------------------ '''
#slv, pin = Measurement.make_64I_inverter_exact(U, evec_path)
#slv, pin = Measurement.make_64I_inverter_mass_exact(U, evec_path, 0.02661)
slv = Measurement.make_debugging_inverter_mixed_exact_mass(U, 0.02661)
