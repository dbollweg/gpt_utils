...
data_dir = "/home/gaox/latwork/DWF/64I/propagator/data/GSRC_W40_k0/"
...
for group, job, conf, jid, n in run_jobs:
    ...
    for pos in source_positions_exact:
        ...
        prop_dir = data_dir + "prop_ex_src/" + conf + "/" + "x"+str(pos[0]) + "y"+str(pos[1]) + "z"+str(pos[2]) + "t"+str(pos[3])
        if g.rank() == 0:
            if not prop_dir:
    ...
    for pos in source_positions_sloppy:
        ...
        prop_dir = data_dir + "prop_sl_src/" + conf + "/" + "x"+str(pos[0]) + "y"+str(pos[1]) + "z"+str(pos[2]) + "t"+str(pos[3])
        if g.rank() == 0:
            if not prop_dir:
                os.makedirs(prop_dir)
        Measurement.set_output_facilities(corr_dir, prop_dir)
