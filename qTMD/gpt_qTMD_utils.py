...
class pion_TMDWF_measurement(pion_measurement):
    ...
    def constr_TMD_bprop_CG(self, prop_b, W_index_list):
        ...
        for i, idx in enumerate(W_index_list):
            ...
            current_eta = idx[2]
            transverse_direction = idx[3]
            prop_list.append(g.eval(g.gamma[5]*g.adj(g.gamma[5]*g.eval(g.cshift(g.cshift(prop_b,transverse_direction,current_b_T),2,round(current_bz)))*g.gamma[5])))
        return prop_list
