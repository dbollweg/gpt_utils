...
for conf_num in 1690 1730 1750 1770 1790 1810 1830 1850 1870 1890
do
    srun -N 32 -n 256 -r $offset --gpus-per-task=1 -u python3 proton_tmd_rc.py --mpi 2.4.4.8 --mpi_split 2.4.4.4 --grid 64.64.64.128 --config_num $conf_num --shm-mpi 1 --shm 2048 --comms-sequential --accelerator-threads 8 > proton_"$conf_num".out &
    offset=$((offset + 32))
    sleep 2
done
wait
